...
export const MobilePostComposer = ({ isOpen, onClose, replyTo, onPostSuccess }: MobilePostComposerProps) => {
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <textarea
                            ...
                            onInput={(e) => updateImageAlt(currentImageIndex, (e.target as HTMLTextAreaElement).value)}
