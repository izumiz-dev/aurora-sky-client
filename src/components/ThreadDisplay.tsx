...
export const ThreadDisplay: FunctionComponent<ThreadDisplayProps> = ({
  ...
  // 直上のポストが返信先かどうかをチェック
  const isDirectReplyToPrevious =
    previousPost && thread.post.record?.reply?.parent?.uri === previousPost.post.uri;
  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-10">
        <PostItem post={thread.post} hideReplyTo={isDirectReplyToPrevious || false} />
      </div>
