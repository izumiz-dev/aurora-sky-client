...
export const ModernLayout: FunctionalComponent<ModernLayoutProps & RouteComponentProps> = ({
  children,
  path,
}) => {
  ...
  return (
    <>
      <header
        className="aurora-gradient-bg fixed top-0 left-0 right-0 w-full z-50 border-b border-white/10 shadow-lg"
          ...
          <div className="flex items-center justify-between h-16 md:h-16 sm:h-12">
            <div className="flex items-center">
              ...
              >
                ...
                <span className="text-xl md:text-xl sm:text-lg font-bold text-white">
                  AuroraSky
                </span>
              </Link>
            </div>
